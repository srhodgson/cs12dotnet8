...
// An array of any time has a Length property
something = new[] {3, 5, 7};
...
// Bad use of var because we cannot tell the type, so we should use a specific type of declaration as shown in the 
// second statement.
